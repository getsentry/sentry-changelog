...
The [Sentry Wizard 8.0.0](https://github.com/getsentry/sentry-wizard/releases/tag/v8.0.0) installs v11 of the SDK for Angular, Cloudflare, Next.js, Nuxt, React Router, Remix and SvelteKit. If your project uses a version below v11, the wizard shows a link to the migration guide.
